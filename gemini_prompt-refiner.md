    ...
    "profiles": [
        {
            "complex_modifications": {
                "rules": [
                    ...
                    {
                        "description": "Avoid send with return",
                        "manipulators": [
                            {
                                "conditions": [
                                    {
                    ...
                    {
                        "description": "括弧を自動的に閉じてカーソルを中に移動",
                        "manipulators": [
                            {
                                "conditions": [
                                    {
                    ...
                    {
                        "description": "Align shortcut keys across apps",
                        "manipulators": [
                            {
                                "conditions": [
                                    {
                                ...
                                "description": "Slack & Notion: cmd + L -> cmd + K (search)",
                                "from": {
                                    "key_code": "l",
                                    "modifiers": {
                            ...
                            },
                            {
                                ...
                                "description": "Notion: cmd + shift + ctrl + C -> cmd + ctrl + L (copy block link)",
                                "from": {
                                    "key_code": "c",
                                    "modifiers": {
                                        "mandatory": ["left_command", "left_shift", "left_control"],
                                        "optional": ["any"]
                                    }
                                },
                                "to": [
                            ...
                            },
                            {
                                ...
                                "description": "Notion: cmd + E -> cmd + shift + C (code)",
                                "from": {
                                    "key_code": "e",
                                    "modifiers": {
                                        "mandatory": ["left_command"],
                    ...
                    {
                        "description": "Open favorites in Arc",
                        "manipulators": [
                            {
                                "from": {
                                    "key_code": "m",
                                ...
                                "to": [{ "shell_command": "osascript -e 'tell application \"Arc.app\" to activate'" }],
                                "to_delayed_action": {
                                    "to_if_invoked": [
                                        {
                                            "key_code": "2",
                    ...
                    {
                        "description": "Open Text Replacements in System Settings",
                        "enabled": false,
                        "manipulators": [
                            {
                                "from": {
                                ...
                                "to": [
                                    { "shell_command": "killall \"/System/Applications/System Settings.app\"" },
